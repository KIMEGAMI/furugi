                ...
                <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        ...
                        <p class="mt-2 max-w-3xl text-sm font-bold leading-7 text-slate-200">
                            商品、売上、送料、手数料、利益をCSVで退避できます。定期的にバックアップしておくと、端末変更や誤操作時の復旧に使えます。
                        </p>
                    </div>
                    @if ($hasActiveSubscription ?? false)
                        <div class="flex flex-col gap-2 sm:flex-row">
                            <a href="{{ route('sales.backup-csv') }}" class="inline-flex items-center justify-center rounded-lg bg-emerald-400 px-5 py-3 text-sm font-black text-slate-950 hover:bg-emerald-300">
                                全商品バックアップCSV
                            </a>
                            <a href="{{ route('sales.restore-csv') }}" class="inline-flex items-center justify-center rounded-lg border border-emerald-300 px-5 py-3 text-sm font-black text-emerald-100 hover:bg-emerald-300/10">
                                復元用CSV
                            </a>
                        </div>
                    @else
