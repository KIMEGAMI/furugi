@php
    ...
    $faqs = [
        ['FreeプランとPremiumプランの違いは何ですか？', 'Freeプランは無料で、商品登録50件、カテゴリ登録5件まで利用できます。Premiumプランは月額480円で、商品登録数とカテゴリ数の制限がなくなり、CSV登録、売上分析、ジャンル別分析、重複チェックなどの機能を利用できます。'],
        ['CSVで一括登録できますか？', 'できます。古着システム用CSV、ヤフオクCSV変換などに対応しています。'],
