...
<x-legal-layout title="特定商取引法に基づく表記" eyebrow="COMMERCIAL TRANSACTIONS" :description="$pageSeo['description']">
    ...
    <dl class="not-prose mt-5 divide-y divide-slate-200 rounded-lg border border-slate-200 bg-slate-50 text-sm font-bold text-slate-700">
        <div class="grid gap-2 p-4 md:grid-cols-[14rem_1fr]">
            <dt class="text-slate-950">販売事業者名</dt>
            <dd>{{ $operatorName ?: '請求があった場合、遅滞なく開示します。' }}</dd>
        </div>
        <div class="grid gap-2 p-4 md:grid-cols-[14rem_1fr]">
            <dt class="text-slate-950">運営責任者</dt>
        ...
        <div class="grid gap-2 p-4 md:grid-cols-[14rem_1fr]">
            <dt class="text-slate-950">お問い合わせ先</dt>
            <dd>
    ...
    <ul>
        <li>Freeプラン: 無料</li>
        <li>Premiumプラン: 月額480円（税込）</li>
    </ul>
    <p>Premiumプランでは、商品登録数とカテゴリ登録数の制限がなくなり、CSV管理、売上分析、ジャンル別売上分析、重複チェックなどのPremium機能を利用できます。</p>

    <h2>商品代金以外の必要料金</h2>
    <p>サービス利用に必要な通信料、インターネット接続料金、端末費用などは利用者の負担となります。デジタルサービスのため、送料は発生しません。</p>

    <h2>支払い方法・支払い時期</h2>
    <p>Premiumプランの支払いはStripeが提供する決済画面を通じて行います。利用できる支払い方法はStripeの決済画面に表示される内容に従います。</p>
    <p>初回の支払いはPremiumプラン申込時に発生し、その後は解約されるまで1か月ごとに自動更新されます。</p>

    <h2>サービス提供時期</h2>
    <p>Premiumプランは、Stripeでの決済完了後、通常すぐに利用できます。通信状況、Stripeの処理状況、メンテナンス等により、反映に時間がかかる場合があります。</p>

    <h2>解約・契約管理</h2>
    <p>Premiumプランは、ログイン後の「契約・解約」画面からStripeの契約管理画面へ進み、解約できます。</p>
