    ...
    <section class="bg-slate-950 py-16 text-white">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <p class="mt-5 max-w-3xl text-base font-semibold leading-8 text-cyan-100">
                FURUGI MANAGERは、フリマ販売や複数販路運用で散らばりやすい商品情報、画像、販売状況、売上、利益をまとめて管理する古着販売向けシステムです。
            </p>
        </div>
    </section>
    ...
    <section class="py-14">
        <div class="mx-auto grid max-w-7xl gap-5 px-4 sm:px-6 md:grid-cols-2 lg:grid-cols-3 lg:px-8">
            @foreach ([
                ...
                ['CSV管理・変換', '古着システムCSVに加えて、ヤフオク売上CSV、メルカリShops CSVなど外部CSVの変換、バックアップCSV、復元用CSVをまとめて管理できます。'],
